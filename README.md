...
Скрипт для проверки выполнения задания конкурса «Профессионалы 2025» (модуль Б).  
Проект позволяет быстро и удобно проверить ваши решения с помощью одной команды.
...
2. Скопируйте команду для запуска скрипта:
